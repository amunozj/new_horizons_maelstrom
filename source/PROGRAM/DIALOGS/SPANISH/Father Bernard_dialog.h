...
"¿Tal vez #sromance# podria ir a algún lugar privado y explicar lo ocurrido con sus propias palabras?",
"Sí, podemos hacerlo. Reúnete conmigo en el confesionario, #sromance_child#.",
"#sromance# me ha explicado las circunstancias de su secuestro, el matrimonio forzado y su encierro posterior. Y cómo te debe su rescate a ti, y al parecer no por primera vez.",
"#sromance# me ha explicado las circunstancias de su secuestro, el matrimonio forzado y su encierro posterior. Y cómo te debe su rescate a ti, ¡cosa que fue toda una sorpresa para #spronoun#!",
"Entonces, ¿se puede cancelar el matrimonio?",
"Eso está más allá de mis capacidades. Todo lo que puedo hacer es escribir al Santo Padre en Roma. Este tipo de cosas pasan más de lo que se cree y, cuando se demuestra que el consentimiento no fue dado libremente, el matrimonio puede ser anulado.\nSerá como si el matrimonio nunca hubiera ocurrido. Pero llevará tiempo, y habrá ciertos costes.",
