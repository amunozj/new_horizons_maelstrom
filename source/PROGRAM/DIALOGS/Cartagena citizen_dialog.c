...
//<-- RobC/A_S 'smiths
		...
		case "town_smithy":
			...
			Link.l3.go = "town_store";
			DeleteAttribute(&locations[FindLocation("Cartagena_Center")], "reload.l8.goto_disable"); // BOP: Unlock Fast Travel
		break;
//<-- RobC/A_S Smiths
		...
		case "town_tavern":
			...
			DeleteAttribute(&locations[FindLocation("Cartagena_Center")], "reload.l5.goto_disable"); // BOP: Unlock Fast Travel
		break;
		...
		case "town_shipyard":
			...
			Link.l3.go = "exit";
			DeleteAttribute(&locations[FindLocation("Cartagena_Center")], "reload.l3.goto_disable"); // BOP: Unlock Fast Travel
		break;
