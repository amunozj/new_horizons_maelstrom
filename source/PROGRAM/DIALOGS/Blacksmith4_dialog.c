...
void ProcessDialogEvent()
{
	...
	case "MakeAllAverage":
		...
		LogIt(BladeCount+ " "+ TranslateString("","hours pass until the work is completed and you receive the blades back."));
	...
	case "MakeAllExcellent":
		...
		LogIt(BladeCount*3+" hours pass until the work is completed and you receive the blades back.");
		WaitDate("", 0, 0, 0, BladeCount*3, 0);
	...
	case "MakeExcellent":
		...
		// Wait three days
		WaitDate("", 0, 0, 3, 0, 0);
		Log_SetStringToLog(LanguageConvertString(tmpLangFileID,"You get your blade back three days later."));
