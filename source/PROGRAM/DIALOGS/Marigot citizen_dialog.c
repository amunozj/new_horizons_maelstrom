...
//<-- RobC/A_S Smiths
		...
		case "town_tavern":
			...
			DeleteAttribute(&locations[FindLocation("Marigot_town_02")], "reload.l7.goto_disable"); // JRH: Unlock Fast Travel
		break;
		...
		case "town_shipyard":
			...
			Link.l3.go = "exit";
			DeleteAttribute(&locations[FindLocation("Marigot_port")], "reload.l8.goto_disable"); // JRH: Unlock Fast Travel
		break;
		...
		case "town_store":
			...
			Link.l3.go = "exit";
			DeleteAttribute(&locations[FindLocation("Marigot_port")], "reload.l6.goto_disable"); // JRH: Unlock Fast Travel
		break;
		...
		case "Marigot":
			d.Text = DLG_TEXT[134] + DLG_TEXT[168] + GetTownSize("Marigot") + DLG_TEXT[169];// NK
