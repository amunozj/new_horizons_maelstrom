...
//<-- RobC/A_S Smiths
		...
		case "town_tavern":
			...
			Link.l5 = DLG_TEXT[170];
			Link.l5.go = "town_tailorsshop";
			DeleteAttribute(&locations[FindLocation("Oranjestad_town")], "reload.l2.goto_disable"); // JRH: Unlock Fast Travel
		break;
		...
		case "town_store":
			...
			Link.l4 = DLG_TEXT[170];
			Link.l4.go = "town_tailorsshop";
			DeleteAttribute(&locations[FindLocation("Oranjestad_town")], "reload.l3.goto_disable"); // JRH: Unlock Fast Travel
		break;
		...
		case "town_tailorsshop":
			...
			Link.l5 = DLG_TEXT[110];
			Link.l5.go = "town_tavern";
			DeleteAttribute(&locations[FindLocation("Oranjestad_town")], "reload.l15.goto_disable"); // JRH: Unlock Fast Travel
		break;
