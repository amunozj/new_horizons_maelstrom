...
//<-- RobC/A_S Smiths
		...
		case "town_shipyard":
			...
			Link.l3.go = "exit";
			DeleteAttribute(&locations[FindLocation("Guadeloupe_port")], "reload.l3.goto_disable"); // JRH: Unlock Fast Travel
		break;
		...
		case "town_store":
			...
			Link.l3.go = "exit";
			DeleteAttribute(&locations[FindLocation("Guadeloupe_port")], "reload.l4.goto_disable"); // JRH: Unlock Fast Travel
		break;
