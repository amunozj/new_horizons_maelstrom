...
//<-- RobC/A_S 'smiths
		...
		case "town_smithy":
			...
			Link.l3.go = "town_store";
			DeleteAttribute(&locations[FindLocation("Havana_Town_02")], "reload.l5.goto_disable"); // BOP: Unlock Fast Travel
		break;
//<-- RobC/A_S Smiths
		...
		case "town_tavern":
			...
			DeleteAttribute(&locations[FindLocation("Havana_Town_02")], "reload.l8.goto_disable"); // BOP: Unlock Fast Travel
		break;
		...
		case "town_shipyard":
			...
			Link.l3.go = "exit";
			DeleteAttribute(&locations[FindLocation("Havana_Town_01")], "reload.l9.goto_disable"); // BOP: Unlock Fast Travel
		break;
		...
		case "town_store":
			...
			Link.l3.go = "exit";
			DeleteAttribute(&locations[FindLocation("Havana_Town_01")], "reload.l11.goto_disable"); // BOP: Unlock Fast Travel
		break;
		...
		case "Havana":
			d.Text = DLG_TEXT[134] + DLG_TEXT[168] + GetTownSize("Havana") + DLG_TEXT[169]; // NK
