...
// changed by MAXIMUS for typing on Russian -->
		...
		switch (typeLanguage) {
			case "Russian":
				CI_CreateAndSetControls("", "NK_Key_�", CI_GetKeyCode("Key_f"), 0, false);
				CI_CreateAndSetControls("", "NK_Key_�", CI_GetKeyCode("VK_OEM_COMMA"), 0, false);
				CI_CreateAndSetControls("", "NK_Key_�", CI_GetKeyCode("Key_d"), 0, false);
				CI_CreateAndSetControls("", "NK_Key_�", CI_GetKeyCode("Key_u"), 0, false);
				CI_CreateAndSetControls("", "NK_Key_�", CI_GetKeyCode("Key_l"), 0, false);
				CI_CreateAndSetControls("", "NK_Key_�", CI_GetKeyCode("Key_t"), 0, false);
				...
				CI_CreateAndSetControls("", "NK_Key_�", CI_GetKeyCode("Key_p"), 0, false);
				CI_CreateAndSetControls("", "NK_Key_�", CI_GetKeyCode("Key_b"), 0, false);
				CI_CreateAndSetControls("", "NK_Key_�", CI_GetKeyCode("Key_q"), 0, false);
				CI_CreateAndSetControls("", "NK_Key_�", CI_GetKeyCode("Key_r"), 0, false);
				CI_CreateAndSetControls("", "NK_Key_�", CI_GetKeyCode("Key_k"), 0, false);
				CI_CreateAndSetControls("", "NK_Key_�", CI_GetKeyCode("Key_v"), 0, false);
				CI_CreateAndSetControls("", "NK_Key_�", CI_GetKeyCode("Key_y"), 0, false);
				CI_CreateAndSetControls("", "NK_Key_�", CI_GetKeyCode("Key_j"), 0, false);
				CI_CreateAndSetControls("", "NK_Key_�", CI_GetKeyCode("Key_g"), 0, false);
				CI_CreateAndSetControls("", "NK_Key_�", CI_GetKeyCode("Key_h"), 0, false);
				CI_CreateAndSetControls("", "NK_Key_�", CI_GetKeyCode("Key_c"), 0, false);
				CI_CreateAndSetControls("", "NK_Key_�", CI_GetKeyCode("Key_n"), 0, false);
				CI_CreateAndSetControls("", "NK_Key_�", CI_GetKeyCode("Key_e"), 0, false);
				CI_CreateAndSetControls("", "NK_Key_�", CI_GetKeyCode("Key_a"), 0, false);
				CI_CreateAndSetControls("", "NK_Key_�", CI_GetKeyCode("VK_OEM_4"), 0, false);
				CI_CreateAndSetControls("", "NK_Key_�", CI_GetKeyCode("Key_w"), 0, false);
				CI_CreateAndSetControls("", "NK_Key_�", CI_GetKeyCode("Key_x"), 0, false);
				CI_CreateAndSetControls("", "NK_Key_�", CI_GetKeyCode("Key_i"), 0, false);
				CI_CreateAndSetControls("", "NK_Key_�", CI_GetKeyCode("Key_o"), 0, false);
				CI_CreateAndSetControls("", "NK_Key_�", CI_GetKeyCode("Key_s"), 0, false);
				...
				CI_CreateAndSetControls("", "NK_Key_�", CI_GetKeyCode("Key_m"), 0, false);
				CI_CreateAndSetControls("", "NK_Key_�", CI_GetKeyCode("VK_OEM_PERIOD"), 0, false);
				CI_CreateAndSetControls("", "NK_Key_�", CI_GetKeyCode("KEY_z"), 0, false);
