		...
		case ENGLAND:
			switch(PlayerRank)
			{
				...
				case 6: // Post Captain
					...
					{
						case "Horatio Hornblower":
							GiveShip2Character(pchar, "RN_Essex", "Lydia", -1, ENGLAND, true, true); // Raze Frigate
						break;
		...
		case FRANCE:
			switch(PlayerRank)
			{
				...
				case 3: // Lieutenant de Vaisseau
					...
					{
						case PERIOD_EARLY_EXPLORERS:
							GiveShip2Character(pchar, "Polacca", "Lèopard", -1, FRANCE, true, true);
						break;
						...
						case PERIOD_REVOLUTIONS:
							GiveShip2Character(pchar, "Brig2", "èlan", -1, FRANCE, true, true);
						break;
				...
				case 4: // Capitaine de Corvette
					switch(GetCurrentPeriod())
					{
						...
						case PERIOD_GOLDEN_AGE_OF_PIRACY:
							GiveShip2Character(pchar, "FR_Postillionen", "Mèduse", -1, FRANCE, true, true); // 6th Rate Frigate
						break;
						...
						case PERIOD_NAPOLEONIC:
							GiveShip2Character(pchar, "FR_Greyhound", "Comte de Trèville", -1, FRANCE, true, true); // Heavy Sloop-of-War
						break;
					}
				break;
				case 5: // Capitaine de Fregate
					switch(GetCurrentPeriod())
					{
						...
						case PERIOD_GOLDEN_AGE_OF_PIRACY:
							GiveShip2Character(pchar, "RN_RaaFrigate", "ètoile", -1, FRANCE, true, true); // Frigate
						break;

						case PERIOD_COLONIAL_POWERS:
							GiveShip2Character(pchar, "Corvette1", "Iphignie", -1, FRANCE, true, true); // Aurora class Frigate
						break;

						case PERIOD_REVOLUTIONS:
							GiveShip2Character(pchar, "Corvette1", "Iphigènie", -1, FRANCE, true, true); // Aurora class Frigate
						break;
				...
				case 6: // Capitaine de Vaisseau
					switch (GetMySimpleOldName(PChar))
					{
						...
						switch(GetCurrentPeriod())
						{
							...
							case PERIOD_GOLDEN_AGE_OF_PIRACY:
								GiveShip2Character(pchar, "FR_Frigate", "Mèduse", -1, FRANCE, true, true); // Rossiya Frigate
							break;
							...
							case PERIOD_REVOLUTIONS:
								GiveShip2Character(pchar, "FR_BattleFrigate", "Achron", -1, FRANCE, true, true); // Artmise class Frigate
							break;
				...
				case 8: // Vice-Amiral
					switch (GetMySimpleOldName(PChar))
					{
						...
						switch(GetCurrentPeriod())
						{
							...
							break;
							case PERIOD_THE_SPANISH_MAIN:
								GiveShip2Character(pchar, "HeavyLineship", "Maillè Brèzè", -1, FRANCE, true, true); // Pinnace-of-War
							break;
							case PERIOD_GOLDEN_AGE_OF_PIRACY:
							...
							break;
							case PERIOD_NAPOLEONIC:
								GiveShip2Character(pchar, "FR_Bellona", "Tômèraire", -1, FRANCE, true, true); // Bellona class 3rd Rate
							break;
						}
					}
				break;
				...
				case 10: // Amiral
					if (GetCompanionIndex(pchar,1) == -1 || GetCompanionIndex(pchar,2) == -1 || GetCompanionIndex(pchar,3) == -1) // GR
					{
						...
						switch(GetCurrentPeriod())
						{
							...
							case PERIOD_REVOLUTIONS:
								GiveShip2Character(ch, "FR_SotL", "Fougueux", -1, FRANCE, true, true); // Intrèpide class 1st Rate
							break;
			...
			switch(PlayerRank)
			{
				...
				case 3: // Alférez de Navío
					switch(GetCurrentPeriod())
					{
						...
						case PERIOD_NAPOLEONIC:
							GiveShip2Character(pchar, "Galeoth1", "Extremea", -1, SPAIN, true, true);
						break;
					}
				break;
				...
				case 5: // Capitán de Corbeta
					...
					{
						case PERIOD_EARLY_EXPLORERS:
							GiveShip2Character(pchar, "SP_ApostolFelipe", "Apostôl Felipe", -1, SPAIN, true, true); //
						break;
				...
				case 10: // Almirante
					if (GetCompanionIndex(pchar,1) == -1 || GetCompanionIndex(pchar,2) == -1 || GetCompanionIndex(pchar,3) == -1) // GR
					{
						...
						switch(GetCurrentPeriod())
						{
							...
							case PERIOD_REVOLUTIONS:
								GiveShip2Character(ch, "FR_FirstRate", "San Carlos", -1, SPAIN, true, true); // Intrpide class 1st Rate
							break;
		...
		case PORTUGAL:
			switch(PlayerRank)
			{
				case 1: // Aspirante
					...
					{
						case PERIOD_EARLY_EXPLORERS:
							GiveShip2Character(pchar, "LuggerCT", "Nossa Senhora da Oliveira e Santo Antônio", -1, PORTUGAL, true, true); // Lugger
						break;
				...
				case 4: // Primeiro-Tenente
					switch(GetCurrentPeriod())
					{
						...
						case PERIOD_REVOLUTIONS:
							GiveShip2Character(pchar, "PO_Greyhound", "Sao Joao Magnnimo", -1, PORTUGAL, true, true); // 6th Rate Frigate
						break;
					...
					if (GetCompanionIndex(pchar,1) == -1 || GetCompanionIndex(pchar,2) == -1 || GetCompanionIndex(pchar,3) == -1) // GR
					{
						switch(GetCurrentPeriod())
						{
							...
							case PERIOD_NAPOLEONIC:
								...
								GiveShip2Character(ch, "RN_Surprise", "Unio", -1, PORTUGAL, true, true); // Unit class Frigate
							break;
						}
						SetCompanionIndex(pchar, -1, GetCharacterIndex(ch.id));
						RemovePassenger  (pchar,     CharacterFromID  (ch.id));
				...
				case 10: // Vice-Almirante
					if (GetCompanionIndex(pchar,1) == -1 || GetCompanionIndex(pchar,2) == -1 || GetCompanionIndex(pchar,3) == -1) // GR
					{
						...
						switch(GetCurrentPeriod())
						{
							...
							case PERIOD_REVOLUTIONS:
								GiveShip2Character(ch, "RN_Superbe", "Santo Augustinho", -1, PORTUGAL, true, true); // Intrpide class 1st Rate
							break;
	...
	switch(iNation)
	{
		...
		case SPAIN:
			switch(PlayerRank)
			{
				...
				break;
				case 3: // Alfrez de Navo
				break;
				case 4: // Teniente de Navo
				break;
				case 5: // Capitn de Corbeta
				break;
				case 6: // Capitn de Fragata
					switch(rand(2))
					{
