...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "quests":
			...
			if (CheckQuestAttribute("OPERA", "ask_Ines_for_Merchant"))
			{
				link.l1 = DLG_TEXT[170];
				link.l1.go = "Merchant1";
				iTest = iTest + 1;
			}
