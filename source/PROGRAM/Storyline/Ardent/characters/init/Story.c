...
// Amt�nio Guajira
	...
	ch.name = TranslateString("", "Amt�nio");
	ch.lastname = TranslateString("", "Guajira");
	ch.id		= "Amt�nio Guajira";
	ch.model = "prison_5";
	ch.sex = "man";
	ch.sound_type = "male_citizen";
	ch.location	= "Smugglers_Fort";
...
// Ayol Bacha
	...
	SetRankTitle(ch, TranslateString("", "Do�a"));
	AddGameCharacter(n, ch);
...
// Spare officer, originally for "Abduction" quest in case Luc�a / Edmundo is a companion captain
	ch.nation = PIRATE;
	ch.old.name = "Emmett";
