void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "node_1":
			...
			link.l2.go = "node_2";
			if(CheckAttribute(Pchar,"eden_info") && Pchar.eden_info == "start")
			{
				link.l3 = DLG_TEXT[114];
				link.l3.go = "Eden_estate";
			}
		break;
		...
		case "Eden_estate":
			...
			link.l1.go = "Eden_estate1";
		break;

		case "Eden_estate1":
			dialog.text = DLG_TEXT[115];
			link.l1 = DLG_TEXT[117];
			link.l1.go = "Eden_estate2";
		break;

		case "Eden_estate2":
			dialog.text = DLG_TEXT[118];
			link.l1 = DLG_TEXT[119];
			link.l1.go = "Eden_estate3";
		break;
		...
		case "Eden_estate3":
			...
			AddDialogExitQuest("governor_info_estate_done");
		break;
	}
}
