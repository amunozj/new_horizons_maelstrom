...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First time":
			...
			if(pchar.location == "Antigua_fakefort1" || pchar.location == "Antigua_fakefort2"
			|| pchar.location == "Antigua_fakefort3" || pchar.location == "Antigua_armory")
			{
				if(CheckCharacterItem(Pchar,"doc61"))
				{
		...
		case "bribe":
			...
			AddMoneytoCharacter(Pchar, -500);		//was -200
