...
// ABOVE JOINS ORIGINAL JACK SPARROW QUEST	^^^^^^^^^^
		...
		case "On_the_trail":
			...
			ChangeCharacterAddressGroup(CharacterFromID("Bootstrap Bill Turner"),"Tortuga_port", "goto", "goto12");	// was "goto16", nowhere near the tavern
			LAi_SetOfficerType(characterFromID("Bootstrap Bill Turner"));						// Make Bootstrap Bill walk towards you
		...
		case "Meet_Bootstrap_Bill2":
			...
			LAi_SetActorType(characterFromID("Bootstrap Bill Turner"));
			LAi_ActorDialog(characterFromID("Bootstrap Bill Turner"),PChar,"",1.5,1.5);
...
//			ChangeCharacterAddressGroup(characterFromID("Cutler Beckett"), "redmond_residence", "goto", "goto8");
		...
		case "back_to_Tia_Dalma":
			Characters[GetCharacterIndex("Pirates_1")].location = "None";
			Characters[GetCharacterIndex("Pirates_2")].location = "None";
			Characters[GetCharacterIndex("Pirates_3")].location = "None";
		...
		case "to_oxbay_shore_complete":
			LAi_LocationFightDisable(&Locations[FindLocation("Oxbay_shore_01")], true);			// So you can't attack Davy Jones nor block his dialog by having a sword drawn
...
//			ChangeCharacterAddress(characterFromID("Turpin Cabanel"), "None", "");
		...
		case "Find_Barbossa_with_Black_Pearl":
			LAi_LocationFightDisable(&Locations[FindLocation("Oxbay_shore_01")], false);
			ChangeCharacterAddress(characterFromID("Annamaria"), "None", "");
...
// Bartolomeu o Portugues CotBP Starts Here
	...
	//JRH return townpeople here
		...
		case "muerte_with_Gibbs_and_Turner":
			if(!IsOfficer(CharacterFromID("Mr. Gibbs")))
			{
...
//			LAi_QuestDelay("muerte_with_Gibbs_and_Turner2", 0.0);
		...
		case "muerte_with_Gibbs_and_Turner2":
			if(IsOfficer(CharacterFromID("Mr. Gibbs"))) RemoveOfficersIndex(PChar, GetCharacterIndex("Mr. Gibbs"));
			else LAi_SetCitizenTypeNoGroup(CharacterFromID("Mr. Gibbs"));
			LAi_SetOfficerType(CharacterFromID("Will Turner"));
			Pchar.quest.meetcrew.win_condition.l1 = "location";
...
//			if(GetRMRelation(PChar, PIRATE) > REL_WAR) SetRMRelation(PChar, PIRATE, REL_WAR);	// GR: Not needed, "Mr. Gibbs" will be hostile anyway, and you might have earned some rank with Pirates by now
			...
			Island_SetReloadEnableGlobal("IsladeMuerte", false);
		...
		case "InterceptorDestroyed":
			...
			bQuestDisableMapEnter = false;
			Island_SetReloadEnableGlobal("IsladeMuerte", true);
...
//			AddQuestRecord("Contact", 13);
	   ...
	   //Go to Elton Garfield on docks
		...
		case "wreck_deck_MD":
			...
			DeleteAttribute(PChar, "quest.S3A_up.win_condition");
			DeleteAttribute(PChar, "quest.S1E_down.win_condition");
			DeleteAttribute(PChar, "quest.S2E_down.win_condition");
		...
		case "wreck_deck_status":
			...
			if(CheckAttribute(Pchar, "wreck_deck") && Pchar.wreck_deck == "FC")
			{
				pchar.quest.S1E_down.win_condition.l1 = "locator";
				pchar.quest.S1E_down.win_condition.l1.location = "SFSI_deck";
				pchar.quest.S1E_down.win_condition.l1.locator_group = "quest";
				pchar.quest.S1E_down.win_condition.l1.locator = "S1_high";
				pchar.quest.S1E_down.win_condition = "S1E_down";

				pchar.quest.S2E_down.win_condition.l1 = "locator";
				pchar.quest.S2E_down.win_condition.l1.location = "SFSI_deck";
				pchar.quest.S2E_down.win_condition.l1.locator_group = "quest";
				pchar.quest.S2E_down.win_condition.l1.locator = "S2_high";
				pchar.quest.S2E_down.win_condition = "S2E_down";
			}

			if(CheckAttribute(Pchar, "wreck_deck") && Pchar.wreck_deck == "QD")
			{
				pchar.quest.S3D_down.win_condition.l1 = "locator";
				pchar.quest.S3D_down.win_condition.l1.location = "SFSI_deck";
				pchar.quest.S3D_down.win_condition.l1.locator_group = "quest";
				pchar.quest.S3D_down.win_condition.l1.locator = "S3_high";
				pchar.quest.S3D_down.win_condition = "S3D_down";

				pchar.quest.S4A_up.win_condition.l1 = "locator";
				pchar.quest.S4A_up.win_condition.l1.location = "SFSI_deck";
				pchar.quest.S4A_up.win_condition.l1.locator_group = "quest";
				pchar.quest.S4A_up.win_condition.l1.locator = "S4_low";
				pchar.quest.S4A_up.win_condition = "S4A_up";
			}
		...
		case "S1A_up":
			...
			ChangeCharacterAddressGroup(Pchar, "SFSI_deck", "goto", "S1A_up");

			LAi_QuestDelay("S1B_up", 0.5);
		break;

		case "S1B_up":
			PlaySound("PEOPLE\step_stairway.wav");
			ChangeCharacterAddressGroup(Pchar, "SFSI_deck", "goto", "S1B_up");

			LAi_QuestDelay("S1C_up", 0.5);
		break;

		case "S1C_up":
			PlaySound("PEOPLE\step_wood2.wav");
			ChangeCharacterAddressGroup(Pchar, "SFSI_deck", "goto", "S1C_up");

			LAi_QuestDelay("S1D_up", 0.5);
		break;

		case "S1D_up":
			PlaySound("PEOPLE\step_stairway2.wav");
			ChangeCharacterAddressGroup(Pchar, "SFSI_deck", "goto", "S1D_up");

			LAi_QuestDelay("S1E_up", 0.5);
		break;

		case "S1E_up":
			PlaySound("PEOPLE\step_wood2.wav");
			ChangeCharacterAddressGroup(Pchar, "SFSI_deck", "goto", "S1E_up");

			LAi_QuestDelay("S1F_up", 0.5);
		break;

		case "S1F_up":
			PlaySound("PEOPLE\run_wood.wav");
			ChangeCharacterAddressGroup(Pchar, "SFSI_deck", "quest", "S1_high");
			LAi_SetActorType(Pchar);
		...
		case "S1E_down":
			...
			LAi_QuestDelay("S1D_down", 0.5);
		break;

		case "S1D_down":
			PlaySound("PEOPLE\step_stairway2.wav");
			ChangeCharacterAddressGroup(Pchar, "SFSI_deck", "goto", "S1D_down");

			LAi_QuestDelay("S1C_down", 0.5);
		break;

		case "S1C_down":
			PlaySound("PEOPLE\step_wood2.wav");
			ChangeCharacterAddressGroup(Pchar, "SFSI_deck", "goto", "S1C_down");

			LAi_QuestDelay("S1B_down", 0.5);
		break;

		case "S1B_down":
			PlaySound("PEOPLE\step_stairway.wav");
			ChangeCharacterAddressGroup(Pchar, "SFSI_deck", "goto", "S1B_down");

			LAi_QuestDelay("S1A_down", 0.5);
		break;

		case "S1A_down":
			PlaySound("PEOPLE\step_wood2.wav");
			ChangeCharacterAddressGroup(Pchar, "SFSI_deck", "goto", "S1A_down");

			LAi_QuestDelay("S1X_down", 0.5);
		break;

		case "S1X_down":
			PlaySound("PEOPLE\run_wood.wav");
			ChangeCharacterAddressGroup(Pchar, "SFSI_deck", "quest", "S1_low");
			LAi_SetActorType(Pchar);
			LAi_ActorGoToLocator(Pchar, "goto", "S1X_down", "wreck_deck_MD", 2.0);
		break;
		...
		case "S2A_up":
			...
			LAi_QuestDelay("S2B_up", 0.5);
		break;

		case "S2B_up":
			PlaySound("PEOPLE\step_wood.wav");
			ChangeCharacterAddressGroup(Pchar, "SFSI_deck", "goto", "S2B_up");

			LAi_QuestDelay("S2C_up", 0.5);
		break;

		case "S2C_up":
			PlaySound("PEOPLE\step_stairway1.wav");
			ChangeCharacterAddressGroup(Pchar, "SFSI_deck", "goto", "S2C_up");

			LAi_QuestDelay("S2D_up", 0.5);
		break;

		case "S2D_up":
			PlaySound("PEOPLE\step_stairway1.wav");
			ChangeCharacterAddressGroup(Pchar, "SFSI_deck", "goto", "S2D_up");

			LAi_QuestDelay("S2E_up", 0.5);
		break;

		case "S2E_up":
			PlaySound("PEOPLE\step_stairway2.wav");
			ChangeCharacterAddressGroup(Pchar, "SFSI_deck", "goto", "S2E_up");

			LAi_QuestDelay("S2F_up", 0.5);
		break;

		case "S2F_up":
			PlaySound("PEOPLE\run_wood.wav");
			ChangeCharacterAddressGroup(Pchar, "SFSI_deck", "quest", "S2_high");
			LAi_SetActorType(Pchar);
		...
		case "S2E_down":
			...
			LAi_QuestDelay("S2D_down", 0.5);
		break;

		case "S2D_down":
			PlaySound("PEOPLE\step_stairway1.wav");
			ChangeCharacterAddressGroup(Pchar, "SFSI_deck", "goto", "S2D_down");

			LAi_QuestDelay("S2C_down", 0.5);
		break;

		case "S2C_down":
			PlaySound("PEOPLE\step_stairway1.wav");
			ChangeCharacterAddressGroup(Pchar, "SFSI_deck", "goto", "S2C_down");

			LAi_QuestDelay("S2B_down", 0.5);
		break;

		case "S2B_down":
			PlaySound("PEOPLE\step_wood.wav");
			ChangeCharacterAddressGroup(Pchar, "SFSI_deck", "goto", "S2B_down");

			LAi_QuestDelay("S2A_down", 0.5);
		break;

		case "S2A_down":
			PlaySound("PEOPLE\step_wood.wav");
			ChangeCharacterAddressGroup(Pchar, "SFSI_deck", "goto", "S2A_down");

			LAi_QuestDelay("S2X_down", 0.5);
		break;

		case "S2X_down":
			PlaySound("PEOPLE\run_wood.wav");
			ChangeCharacterAddressGroup(Pchar, "SFSI_deck", "quest", "S2_low");
			LAi_SetActorType(Pchar);
		...
		case "S3A_up":
			PlaySound("PEOPLE\step_stairway.wav");
			ChangeCharacterAddressGroup(Pchar, "SFSI_deck", "goto", "S3A_up");

			LAi_QuestDelay("S3B_up", 0.5);
		break;

		case "S3B_up":
			PlaySound("PEOPLE\step_stairway.wav");
			ChangeCharacterAddressGroup(Pchar, "SFSI_deck", "goto", "S3B_up");

			LAi_QuestDelay("S3C_up", 0.5);
		break;

		case "S3C_up":
			PlaySound("PEOPLE\creak2.wav");
			ChangeCharacterAddressGroup(Pchar, "SFSI_deck", "goto", "S3C_up");

			LAi_QuestDelay("S3D_up", 0.5);
		break;

		case "S3D_up":
			PlaySound("PEOPLE\step_stairway2.wav");
			ChangeCharacterAddressGroup(Pchar, "SFSI_deck", "goto", "S3D_up");

			LAi_QuestDelay("S3F_up", 0.5);
		break;

		case "S3F_up":
			PlaySound("PEOPLE\run_wood.wav");
			ChangeCharacterAddressGroup(Pchar, "SFSI_deck", "quest", "S3_high");
			LAi_SetActorType(Pchar);
			LAi_ActorGoToLocator(Pchar, "goto", "S3F_up", "wreck_deck_QD", 2.0);
		break;
		...
		case "S3D_down":
			PlaySound("PEOPLE\step_stairway2.wav");
			ChangeCharacterAddressGroup(Pchar, "SFSI_deck", "goto", "S3D_down");

			LAi_QuestDelay("S3C_down", 0.5);
		break;

		case "S3C_down":
			PlaySound("PEOPLE\creak2.wav");
			ChangeCharacterAddressGroup(Pchar, "SFSI_deck", "goto", "S3C_down");

			LAi_QuestDelay("S3B_down", 0.5);
		break;

		case "S3B_down":
			PlaySound("PEOPLE\step_stairway.wav");
			ChangeCharacterAddressGroup(Pchar, "SFSI_deck", "goto", "S3B_down");

			LAi_QuestDelay("S3A_down", 0.5);
		break;

		case "S3A_down":
			PlaySound("PEOPLE\step_stairway.wav");
			ChangeCharacterAddressGroup(Pchar, "SFSI_deck", "goto", "S3A_down");

			LAi_QuestDelay("S3X_down", 0.5);
		break;

		case "S3X_down":
			PlaySound("PEOPLE\run_wood.wav");
			ChangeCharacterAddressGroup(Pchar, "SFSI_deck", "quest", "S3_low");
			LAi_SetActorType(Pchar);
			LAi_ActorGoToLocator(Pchar, "goto", "S3X_down", "wreck_deck_MD", 2.0);
		break;
		...
		case "S4A_up":
			...
			ChangeCharacterAddressGroup(Pchar, "SFSI_deck", "goto", "S4A");

			LAi_QuestDelay("S4B_up", 0.5);
		break;

		case "S4B_up":
			PlaySound("AMBIENT\CHURCH\bench1.wav");
			ChangeCharacterAddressGroup(Pchar, "SFSI_deck", "goto", "S4B");

			LAi_QuestDelay("S4C_up", 0.5);
		break;

		case "S4C_up":
			PlaySound("AMBIENT\CHURCH\bench1.wav");
			ChangeCharacterAddressGroup(Pchar, "SFSI_deck", "goto", "S4C");

			LAi_QuestDelay("S4D_up", 0.5);
		break;

		case "S4D_up":
			PlaySound("AMBIENT\CHURCH\bench1.wav");
			ChangeCharacterAddressGroup(Pchar, "SFSI_deck", "goto", "S4D");

			LAi_QuestDelay("S4F_up", 0.5);
		break;

		case "S4F_up":
			PlaySound("AMBIENT\CHURCH\bench1.wav");
			ChangeCharacterAddressGroup(Pchar, "SFSI_deck", "goto", "S4E_up");

			LAi_QuestDelay("S4E_up", 0.5);
		break;

		case "S4E_up":
			PlaySound("PEOPLE\run_wood.wav");
			ChangeCharacterAddressGroup(Pchar, "SFSI_deck", "goto", "S4F_up");

			LAi_QuestDelay("wreck_deck_PD", 1.0);
		break;
		...
		case "S4_high":
			LAi_SetActorType(Pchar);
			ChangeCharacterAddressGroup(Pchar, "SFSI_deck", "goto", "S4_high");

			LAi_QuestDelay("S4_high_turn", 0.5);
		break;

		case "S4_high_turn":
			LAi_ActorTurnToLocator(Pchar, "goto", "look");

			LAi_QuestDelay("S4D_down", 1.0);
		break;
		...
		case "S4A_down":
			...
			LAi_QuestDelay("S4_low_down", 0.5);
		break;

		case "S4_low_down":
			PlaySound("PEOPLE\recoil.wav");
			ChangeCharacterAddressGroup(Pchar, "SFSI_deck", "quest", "S4_low");
			LAi_SetActorType(Pchar);

			LAi_QuestDelay("S4X_down_turn", 0.5);
		break;

		case "S4X_down_turn":
			LAi_ActorTurnToLocator(Pchar, "goto", "S4X_down");

			LAi_QuestDelay("S4X_down", 1.0);
		break;

		case "S4X_down":
			PlaySound("PEOPLE\run_wood.wav");
			ChangeCharacterAddressGroup(Pchar, "SFSI_deck", "goto", "S4X_down");

			LAi_QuestDelay("wreck_deck_QD", 1.0);
		break;
		...
		case "GY_SBR_jump_to_air1":
			ChangeCharacterAddressGroup(Pchar, "Graveyard_SBR", "quest", "air1");

			LAi_QuestDelay("GY_SBR_jump_to_q2", 0.5);
		break;

		case "GY_SBR_jump_to_q2":
			PlaySound("PEOPLE\jump_roof.wav");
			ChangeCharacterAddressGroup(Pchar, "Graveyard_SBR", "quest", "q2");
		...
		case "to_church_roof":
			PlaySound("PEOPLE\recoil.wav");
			ChangeCharacterAddressGroup(Pchar, "Graveyard_SBR", "quest", "q4");
		break;

		case "counter_openclose":
		...
		case "Singapore_check_points":
			LAi_SetPlayerType(Pchar);

			pchar.quest.S_st1.win_condition.l1 = "locator";
			pchar.quest.S_st1.win_condition.l1.location = "Singapore_port";
			pchar.quest.S_st1.win_condition.l1.locator_group = "quest";
			pchar.quest.S_st1.win_condition.l1.locator = "st1";
			pchar.quest.S_st1.win_condition = "S_st1";

			pchar.quest.S_st2.win_condition.l1 = "locator";
			pchar.quest.S_st2.win_condition.l1.location = "Singapore_port";
			pchar.quest.S_st2.win_condition.l1.locator_group = "quest";
			pchar.quest.S_st2.win_condition.l1.locator = "st2";
			pchar.quest.S_st2.win_condition = "S_st2";

			pchar.quest.S_st3.win_condition.l1 = "locator";
			pchar.quest.S_st3.win_condition.l1.location = "Singapore_port";
			pchar.quest.S_st3.win_condition.l1.locator_group = "quest";
			pchar.quest.S_st3.win_condition.l1.locator = "st3";
			pchar.quest.S_st3.win_condition = "S_st3";

			pchar.quest.S_ho.win_condition.l1 = "locator";
			pchar.quest.S_ho.win_condition.l1.location = "Singapore_port";
			pchar.quest.S_ho.win_condition.l1.locator_group = "quest";
			pchar.quest.S_ho.win_condition.l1.locator = "ho";
			pchar.quest.S_ho.win_condition = "S_ho";

			pchar.quest.S_ya.win_condition.l1 = "locator";
			pchar.quest.S_ya.win_condition.l1.location = "Singapore_port";
			pchar.quest.S_ya.win_condition.l1.locator_group = "quest";
			pchar.quest.S_ya.win_condition.l1.locator = "ya";
			pchar.quest.S_ya.win_condition = "S_ya";

			pchar.quest.S_br.win_condition.l1 = "locator";
			pchar.quest.S_br.win_condition.l1.location = "Singapore_port";
			...
			pchar.quest.extra1.win_condition.l1.locator = "extra1";
			pchar.quest.extra1.win_condition = "extra1";

			pchar.quest.extra2.win_condition.l1 = "locator";
			pchar.quest.extra2.win_condition.l1.location = "Singapore_port";
			pchar.quest.extra2.win_condition.l1.locator_group = "quest";
			pchar.quest.extra2.win_condition.l1.locator = "extra2";
			pchar.quest.extra2.win_condition = "extra2";

			pchar.quest.headache.win_condition.l1 = "locator";
			pchar.quest.headache.win_condition.l1.location = "Singapore_port";
			pchar.quest.headache.win_condition.l1.locator_group = "quest";
			pchar.quest.headache.win_condition.l1.locator = "headache";
			pchar.quest.headache.win_condition = "headache";

			pchar.quest.ladder_L.win_condition.l1 = "locator";
			pchar.quest.ladder_L.win_condition.l1.location = "Singapore_port";
			pchar.quest.ladder_L.win_condition.l1.locator_group = "quest";
			pchar.quest.ladder_L.win_condition.l1.locator = "ladder_L";
			pchar.quest.ladder_L.win_condition = "ladder_L";

			pchar.quest.ladder_R.win_condition.l1 = "locator";
			pchar.quest.ladder_R.win_condition.l1.location = "Singapore_port";
			pchar.quest.ladder_R.win_condition.l1.locator_group = "quest";
			pchar.quest.ladder_R.win_condition.l1.locator = "ladder_R";
			pchar.quest.ladder_R.win_condition = "ladder_R";
		break;

		case "S_st1":
			if(CheckAttribute(Pchar, "Singapore_pos"))
			{
				switch(Pchar.Singapore_pos)
				{
					case "1":
						ChangeCharacterAddressGroup(Pchar, "Singapore_port", "quest", "st1_up");
						Pchar.Singapore_pos = "2";

						LAi_QuestDelay("S_officers_stairs_up", 0.001);
					break;

					case "2":
						ChangeCharacterAddressGroup(Pchar, "Singapore_port", "quest", "st1_down");
						Pchar.Singapore_pos = "1";

						LAi_QuestDelay("S_officers_stairs_down", 0.001);
					break;
				}
			}
		...
		case "S_st2":
			if(CheckAttribute(Pchar, "Singapore_pos"))
			{
				...
				{
					case "1":
						ChangeCharacterAddressGroup(Pchar, "Singapore_port", "quest", "st2_up");
						Pchar.Singapore_pos = "2";
					...
					case "2":
						ChangeCharacterAddressGroup(Pchar, "Singapore_port", "quest", "st2_down");
						Pchar.Singapore_pos = "1";
		...
		case "S_st3":
			if(CheckAttribute(Pchar, "Singapore_pos"))
			{
				...
				{
					case "1":
						ChangeCharacterAddressGroup(Pchar, "Singapore_port", "quest", "st3_up");
						Pchar.Singapore_pos = "2";
					...
					case "2":
						ChangeCharacterAddressGroup(Pchar, "Singapore_port", "quest", "st3_down");
						Pchar.Singapore_pos = "1";
		...
		case "S_officers_stairs_up":
			if(GetOfficersIndex(Pchar, 1) != -1)
			{
				iPassenger = GetOfficersIndex(Pchar, 1);
				ChangeCharacterAddressGroup(&Characters[iPassenger], "Singapore_port", "quest", "st1_up");
			}

			if(GetOfficersIndex(Pchar, 2) != -1)
			{
				iPassenger = GetOfficersIndex(Pchar, 2);
				ChangeCharacterAddressGroup(&Characters[iPassenger], "Singapore_port", "quest", "st2_up");
			}
		...
		case "S_officers_stairs_down":
			if(GetOfficersIndex(Pchar, 1) != -1)
			{
				iPassenger = GetOfficersIndex(Pchar, 1);
				ChangeCharacterAddressGroup(&Characters[iPassenger], "Singapore_port", "quest", "st1_down");
			}

			if(GetOfficersIndex(Pchar, 2) != -1)
			{
				iPassenger = GetOfficersIndex(Pchar, 2);
				ChangeCharacterAddressGroup(&Characters[iPassenger], "Singapore_port", "quest", "st2_down");
			}
		...
		case "S_ho":
			if(CheckAttribute(Pchar, "Singapore_pos"))
			{
				...
				{
					case "1":
						ChangeCharacterAddressGroup(Pchar, "Singapore_port", "quest", "ho_up");
						Pchar.Singapore_pos = "2";
					break;

					case "2":
						ChangeCharacterAddressGroup(Pchar, "Singapore_port", "quest", "ho_down");
						Pchar.Singapore_pos = "1";
					break;
				}
			}
		...
		case "S_ya":
			if(CheckAttribute(Pchar, "Singapore_pos"))
			{
				...
				{
					case "1":
						ChangeCharacterAddressGroup(Pchar, "Singapore_port", "quest", "ya_in");
						Pchar.Singapore_pos = "2";

						if(GetOfficersIndex(Pchar, 1) != -1)
						{
							iPassenger = GetOfficersIndex(Pchar, 1);
							ChangeCharacterAddressGroup(&Characters[iPassenger], "Singapore_port", "quest", "ya_in1");
						}

						if(GetOfficersIndex(Pchar, 2) != -1)
						{
							iPassenger = GetOfficersIndex(Pchar, 2);
							ChangeCharacterAddressGroup(&Characters[iPassenger], "Singapore_port", "quest", "ya_in2");
						}

						if(GetOfficersIndex(Pchar, 3) != -1)
						{
							iPassenger = GetOfficersIndex(Pchar, 3);
							ChangeCharacterAddressGroup(&Characters[iPassenger], "Singapore_port", "quest", "ya_in3");
						}
					break;

					case "2":
						ChangeCharacterAddressGroup(Pchar, "Singapore_port", "quest", "ya_out");
						Pchar.Singapore_pos = "1";

						if(GetOfficersIndex(Pchar, 1) != -1)
						{
							iPassenger = GetOfficersIndex(Pchar, 1);
							ChangeCharacterAddressGroup(&Characters[iPassenger], "Singapore_port", "quest", "ya_out1");
						}

						if(GetOfficersIndex(Pchar, 2) != -1)
						{
							iPassenger = GetOfficersIndex(Pchar, 2);
							ChangeCharacterAddressGroup(&Characters[iPassenger], "Singapore_port", "quest", "ya_out2");
						}

						if(GetOfficersIndex(Pchar, 3) != -1)
						{
							iPassenger = GetOfficersIndex(Pchar, 3);
							ChangeCharacterAddressGroup(&Characters[iPassenger], "Singapore_port", "quest", "ya_out3");
						}
					break;
				}
			}
		...
		case "S_br":
			if(CheckAttribute(Pchar, "Singapore_pos"))
			{
				...
				{
					case "1":
						ChangeCharacterAddressGroup(Pchar, "Singapore_port", "quest", "br_up");
						Pchar.Singapore_pos = "2";
					break;

					case "2":
						ChangeCharacterAddressGroup(Pchar, "Singapore_port", "quest", "br_down");
						Pchar.Singapore_pos = "1";
					break;
				}
			}
		...
		case "S_tunnel":
			if(CheckAttribute(Locations[FindLocation(Pchar.location)], "type"))
			{
				switch(Locations[FindLocation(Pchar.location)].type)
				{
					case "silent_port":
						PauseAllSounds();
						Locations[FindLocation(Pchar.location)].type = "Singapore_town";
		...
		case "headache":
			...
			ChangeCharacterAddressGroup(Pchar, "Singapore_port", "quest", "headache_sit");
		...
		case "ladder_L":
			LAi_SetStayType(Pchar);
			ChangeCharacterAddressGroup(Pchar, "Singapore_port", "quest", "ladder_Lback");

			if(PChar.sex == "man")
			{
				//PlaySound("VOICE\ENGLISH\blaze_sigh.wav");
				PlaySound("OBJECTS\VOICES\DEAD\male\dead1.wav");	//ohoh
			}
		...
		case "ladder_R":
			LAi_SetStayType(Pchar);
			ChangeCharacterAddressGroup(Pchar, "Singapore_port", "quest", "ladder_Rback");
		...
		// --> JRH Singapore_bathhouse

		case "Bathhouse_check_points":
			pchar.quest.BH_SS2.win_condition.l1 = "locator";
			pchar.quest.BH_SS2.win_condition.l1.location = "Singapore_bathhouse";
			pchar.quest.BH_SS2.win_condition.l1.locator_group = "quest";
			pchar.quest.BH_SS2.win_condition.l1.locator = "SS2";
			pchar.quest.BH_SS2.win_condition = "BH_SS2";

			pchar.quest.BH_SS3.win_condition.l1 = "locator";
			pchar.quest.BH_SS3.win_condition.l1.location = "Singapore_bathhouse";
			pchar.quest.BH_SS3.win_condition.l1.locator_group = "quest";
			pchar.quest.BH_SS3.win_condition.l1.locator = "SS3";
			pchar.quest.BH_SS3.win_condition = "BH_SS3";

			pchar.quest.BH_SS4.win_condition.l1 = "locator";
			pchar.quest.BH_SS4.win_condition.l1.location = "Singapore_bathhouse";
			pchar.quest.BH_SS4.win_condition.l1.locator_group = "quest";
			pchar.quest.BH_SS4.win_condition.l1.locator = "SS4";
			pchar.quest.BH_SS4.win_condition = "BH_SS4";

			//-------------------------------------------------------------------

			pchar.quest.BH_WW1.win_condition.l1 = "locator";
			pchar.quest.BH_WW1.win_condition.l1.location = "Singapore_bathhouse";
			pchar.quest.BH_WW1.win_condition.l1.locator_group = "quest";
			pchar.quest.BH_WW1.win_condition.l1.locator = "WW1";
			pchar.quest.BH_WW1.win_condition = "BH_WW1";

			pchar.quest.BH_WW2.win_condition.l1 = "locator";
			pchar.quest.BH_WW2.win_condition.l1.location = "Singapore_bathhouse";
			pchar.quest.BH_WW2.win_condition.l1.locator_group = "quest";
			pchar.quest.BH_WW2.win_condition.l1.locator = "WW2";
			pchar.quest.BH_WW2.win_condition = "BH_WW2";

			pchar.quest.BH_WW3.win_condition.l1 = "locator";
			pchar.quest.BH_WW3.win_condition.l1.location = "Singapore_bathhouse";
			pchar.quest.BH_WW3.win_condition.l1.locator_group = "quest";
			pchar.quest.BH_WW3.win_condition.l1.locator = "WW3";
			pchar.quest.BH_WW3.win_condition = "BH_WW3";

			pchar.quest.BH_WW4.win_condition.l1 = "locator";
			pchar.quest.BH_WW4.win_condition.l1.location = "Singapore_bathhouse";
			pchar.quest.BH_WW4.win_condition.l1.locator_group = "quest";
			pchar.quest.BH_WW4.win_condition.l1.locator = "WW4";
			pchar.quest.BH_WW4.win_condition = "BH_WW4";

			pchar.quest.BH_WW5.win_condition.l1 = "locator";
			pchar.quest.BH_WW5.win_condition.l1.location = "Singapore_bathhouse";
			pchar.quest.BH_WW5.win_condition.l1.locator_group = "quest";
			pchar.quest.BH_WW5.win_condition.l1.locator = "WW5";
			pchar.quest.BH_WW5.win_condition = "BH_WW5";

			//-------------------------------------------------------------------

			pchar.quest.BH_EE1.win_condition.l1 = "locator";
			pchar.quest.BH_EE1.win_condition.l1.location = "Singapore_bathhouse";
			pchar.quest.BH_EE1.win_condition.l1.locator_group = "quest";
			pchar.quest.BH_EE1.win_condition.l1.locator = "EE1";
			pchar.quest.BH_EE1.win_condition = "BH_EE1";

			pchar.quest.BH_EE2.win_condition.l1 = "locator";
			pchar.quest.BH_EE2.win_condition.l1.location = "Singapore_bathhouse";
			pchar.quest.BH_EE2.win_condition.l1.locator_group = "quest";
			pchar.quest.BH_EE2.win_condition.l1.locator = "EE2";
			pchar.quest.BH_EE2.win_condition = "BH_EE2";

			pchar.quest.BH_EE3.win_condition.l1 = "locator";
			pchar.quest.BH_EE3.win_condition.l1.location = "Singapore_bathhouse";
			pchar.quest.BH_EE3.win_condition.l1.locator_group = "quest";
			pchar.quest.BH_EE3.win_condition.l1.locator = "EE3";
			pchar.quest.BH_EE3.win_condition = "BH_EE3";

			pchar.quest.BH_EE4.win_condition.l1 = "locator";
			pchar.quest.BH_EE4.win_condition.l1.location = "Singapore_bathhouse";
			pchar.quest.BH_EE4.win_condition.l1.locator_group = "quest";
			pchar.quest.BH_EE4.win_condition.l1.locator = "EE4";
			pchar.quest.BH_EE4.win_condition = "BH_EE4";

			pchar.quest.BH_EE5.win_condition.l1 = "locator";
			pchar.quest.BH_EE5.win_condition.l1.location = "Singapore_bathhouse";
			pchar.quest.BH_EE5.win_condition.l1.locator_group = "quest";
			pchar.quest.BH_EE5.win_condition.l1.locator = "EE5";
			pchar.quest.BH_EE5.win_condition = "BH_EE5";

			//-------------------------------------------------------------------

			pchar.quest.BH_NN1.win_condition.l1 = "locator";
			pchar.quest.BH_NN1.win_condition.l1.location = "Singapore_bathhouse";
			pchar.quest.BH_NN1.win_condition.l1.locator_group = "quest";
			pchar.quest.BH_NN1.win_condition.l1.locator = "NN1";
			pchar.quest.BH_NN1.win_condition = "BH_NN1";

			pchar.quest.BH_NN2.win_condition.l1 = "locator";
			pchar.quest.BH_NN2.win_condition.l1.location = "Singapore_bathhouse";
			pchar.quest.BH_NN2.win_condition.l1.locator_group = "quest";
			pchar.quest.BH_NN2.win_condition.l1.locator = "NN2";
			pchar.quest.BH_NN2.win_condition = "BH_NN2";

			pchar.quest.BH_NN3.win_condition.l1 = "locator";
			pchar.quest.BH_NN3.win_condition.l1.location = "Singapore_bathhouse";
			pchar.quest.BH_NN3.win_condition.l1.locator_group = "quest";
			pchar.quest.BH_NN3.win_condition.l1.locator = "NN3";
			pchar.quest.BH_NN3.win_condition = "BH_NN3";

			pchar.quest.BH_NN4.win_condition.l1 = "locator";
			pchar.quest.BH_NN4.win_condition.l1.location = "Singapore_bathhouse";
			pchar.quest.BH_NN4.win_condition.l1.locator_group = "quest";
			pchar.quest.BH_NN4.win_condition.l1.locator = "NN4";
			pchar.quest.BH_NN4.win_condition = "BH_NN4";

			pchar.quest.BH_NN5.win_condition.l1 = "locator";
			pchar.quest.BH_NN5.win_condition.l1.location = "Singapore_bathhouse";
			pchar.quest.BH_NN5.win_condition.l1.locator_group = "quest";
			pchar.quest.BH_NN5.win_condition.l1.locator = "NN5";
			pchar.quest.BH_NN5.win_condition = "BH_NN5";

			//---------------------------------------------------
			//---------------------------------------------------

			pchar.quest.BH_SC1.win_condition.l1 = "locator";
			pchar.quest.BH_SC1.win_condition.l1.location = "Singapore_bathhouse";
			...
			pchar.quest.BH_SC2.win_condition.l1.locator = "SC2";
			pchar.quest.BH_SC2.win_condition = "BH_SC2";

			pchar.quest.BH_SC3.win_condition.l1 = "locator";
			pchar.quest.BH_SC3.win_condition.l1.location = "Singapore_bathhouse";
			pchar.quest.BH_SC3.win_condition.l1.locator_group = "quest";
			pchar.quest.BH_SC3.win_condition.l1.locator = "SC3";
			pchar.quest.BH_SC3.win_condition = "BH_SC3";

			pchar.quest.BH_SC4.win_condition.l1 = "locator";
			pchar.quest.BH_SC4.win_condition.l1.location = "Singapore_bathhouse";
			pchar.quest.BH_SC4.win_condition.l1.locator_group = "quest";
			pchar.quest.BH_SC4.win_condition.l1.locator = "SC4";
			pchar.quest.BH_SC4.win_condition = "BH_SC4";

			pchar.quest.BH_SC5.win_condition.l1 = "locator";
			pchar.quest.BH_SC5.win_condition.l1.location = "Singapore_bathhouse";
			pchar.quest.BH_SC5.win_condition.l1.locator_group = "quest";
			pchar.quest.BH_SC5.win_condition.l1.locator = "SC5";
			pchar.quest.BH_SC5.win_condition = "BH_SC5";

			//-------------------------------------------------------------------

			pchar.quest.BH_WC1.win_condition.l1 = "locator";
			pchar.quest.BH_WC1.win_condition.l1.location = "Singapore_bathhouse";
			pchar.quest.BH_WC1.win_condition.l1.locator_group = "quest";
			pchar.quest.BH_WC1.win_condition.l1.locator = "WC1";
			pchar.quest.BH_WC1.win_condition = "BH_WC1";

			pchar.quest.BH_WC2.win_condition.l1 = "locator";
			pchar.quest.BH_WC2.win_condition.l1.location = "Singapore_bathhouse";
			pchar.quest.BH_WC2.win_condition.l1.locator_group = "quest";
			pchar.quest.BH_WC2.win_condition.l1.locator = "WC2";
			pchar.quest.BH_WC2.win_condition = "BH_WC2";

			pchar.quest.BH_WC3.win_condition.l1 = "locator";
			pchar.quest.BH_WC3.win_condition.l1.location = "Singapore_bathhouse";
			pchar.quest.BH_WC3.win_condition.l1.locator_group = "quest";
			pchar.quest.BH_WC3.win_condition.l1.locator = "WC3";
			pchar.quest.BH_WC3.win_condition = "BH_WC3";

			pchar.quest.BH_WC4.win_condition.l1 = "locator";
			pchar.quest.BH_WC4.win_condition.l1.location = "Singapore_bathhouse";
			pchar.quest.BH_WC4.win_condition.l1.locator_group = "quest";
			pchar.quest.BH_WC4.win_condition.l1.locator = "WC4";
			pchar.quest.BH_WC4.win_condition = "BH_WC4";

			pchar.quest.BH_WC5.win_condition.l1 = "locator";
			pchar.quest.BH_WC5.win_condition.l1.location = "Singapore_bathhouse";
			pchar.quest.BH_WC5.win_condition.l1.locator_group = "quest";
			pchar.quest.BH_WC5.win_condition.l1.locator = "WC5";
			pchar.quest.BH_WC5.win_condition = "BH_WC5";

			//-------------------------------------------------------------------

			pchar.quest.BH_EC1.win_condition.l1 = "locator";
			pchar.quest.BH_EC1.win_condition.l1.location = "Singapore_bathhouse";
			pchar.quest.BH_EC1.win_condition.l1.locator_group = "quest";
			pchar.quest.BH_EC1.win_condition.l1.locator = "EC1";
			pchar.quest.BH_EC1.win_condition = "BH_EC1";

			pchar.quest.BH_EC2.win_condition.l1 = "locator";
			pchar.quest.BH_EC2.win_condition.l1.location = "Singapore_bathhouse";
			pchar.quest.BH_EC2.win_condition.l1.locator_group = "quest";
			pchar.quest.BH_EC2.win_condition.l1.locator = "EC2";
			pchar.quest.BH_EC2.win_condition = "BH_EC2";

			pchar.quest.BH_EC3.win_condition.l1 = "locator";
			pchar.quest.BH_EC3.win_condition.l1.location = "Singapore_bathhouse";
			pchar.quest.BH_EC3.win_condition.l1.locator_group = "quest";
			pchar.quest.BH_EC3.win_condition.l1.locator = "EC3";
			pchar.quest.BH_EC3.win_condition = "BH_EC3";

			pchar.quest.BH_EC4.win_condition.l1 = "locator";
			pchar.quest.BH_EC4.win_condition.l1.location = "Singapore_bathhouse";
			pchar.quest.BH_EC4.win_condition.l1.locator_group = "quest";
			pchar.quest.BH_EC4.win_condition.l1.locator = "EC4";
			pchar.quest.BH_EC4.win_condition = "BH_EC4";

			pchar.quest.BH_EC5.win_condition.l1 = "locator";
			pchar.quest.BH_EC5.win_condition.l1.location = "Singapore_bathhouse";
			pchar.quest.BH_EC5.win_condition.l1.locator_group = "quest";
			pchar.quest.BH_EC5.win_condition.l1.locator = "EC5";
			pchar.quest.BH_EC5.win_condition = "BH_EC5";

			//-------------------------------------------------------------------

			pchar.quest.BH_NC1.win_condition.l1 = "locator";
			pchar.quest.BH_NC1.win_condition.l1.location = "Singapore_bathhouse";
			pchar.quest.BH_NC1.win_condition.l1.locator_group = "quest";
			pchar.quest.BH_NC1.win_condition.l1.locator = "NC1";
			pchar.quest.BH_NC1.win_condition = "BH_NC1";

			pchar.quest.BH_NC2.win_condition.l1 = "locator";
			pchar.quest.BH_NC2.win_condition.l1.location = "Singapore_bathhouse";
			pchar.quest.BH_NC2.win_condition.l1.locator_group = "quest";
			pchar.quest.BH_NC2.win_condition.l1.locator = "NC2";
			pchar.quest.BH_NC2.win_condition = "BH_NC2";

			pchar.quest.BH_NC3.win_condition.l1 = "locator";
			pchar.quest.BH_NC3.win_condition.l1.location = "Singapore_bathhouse";
			pchar.quest.BH_NC3.win_condition.l1.locator_group = "quest";
			pchar.quest.BH_NC3.win_condition.l1.locator = "NC3";
			pchar.quest.BH_NC3.win_condition = "BH_NC3";

			pchar.quest.BH_NC4.win_condition.l1 = "locator";
			pchar.quest.BH_NC4.win_condition.l1.location = "Singapore_bathhouse";
			pchar.quest.BH_NC4.win_condition.l1.locator_group = "quest";
			pchar.quest.BH_NC4.win_condition.l1.locator = "NC4";
			pchar.quest.BH_NC4.win_condition = "BH_NC4";

			pchar.quest.BH_NC5.win_condition.l1 = "locator";
			pchar.quest.BH_NC5.win_condition.l1.location = "Singapore_bathhouse";
			pchar.quest.BH_NC5.win_condition.l1.locator_group = "quest";
			pchar.quest.BH_NC5.win_condition.l1.locator = "NC5";
			pchar.quest.BH_NC5.win_condition = "BH_NC5";
		break;

		case "BH_SS2":
			if(CheckAttribute(Pchar, "Bathhouse_pos"))
			{
				switch(Pchar.Bathhouse_pos)
				{
					case "2":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "ss2_up");
						Pchar.Bathhouse_pos = "3";

						LAi_QuestDelay("BH_officers_SS_up", 0.001);
					break;

					case "3":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "ss2_do");
						Pchar.Bathhouse_pos = "2";
					break;
				}
			}

			LAi_QuestDelay("Bathhouse_check_points", 0.01);
		break;
		...
		case "BH_SS3":
			if(CheckAttribute(Pchar, "Bathhouse_pos"))
			{
				...
				{
					case "2":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "ss3_up");
						Pchar.Bathhouse_pos = "3";
					...
					case "3":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "ss3_do");
						Pchar.Bathhouse_pos = "2";
					break;
				}
			}
		...
		case "BH_SS4":
			if(CheckAttribute(Pchar, "Bathhouse_pos"))
			{
				...
				{
					case "2":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "ss4_up");
						Pchar.Bathhouse_pos = "3";
					...
					case "3":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "ss4_do");
						Pchar.Bathhouse_pos = "2";
					break;
				}
			}
		...
		case "BH_officers_SS_up":
			if(GetOfficersIndex(Pchar, 1) != -1)
			{
				iPassenger = GetOfficersIndex(Pchar, 1);
				ChangeCharacterAddressGroup(&Characters[iPassenger], "Singapore_bathhouse", "quest", "ss4_up");
			}

			if(GetOfficersIndex(Pchar, 2) != -1)
			{
				iPassenger = GetOfficersIndex(Pchar, 2);
				ChangeCharacterAddressGroup(&Characters[iPassenger], "Singapore_bathhouse", "quest", "ss3_up");
			}

			if(GetOfficersIndex(Pchar, 3) != -1)
			{
				iPassenger = GetOfficersIndex(Pchar, 3);
				ChangeCharacterAddressGroup(&Characters[iPassenger], "Singapore_bathhouse", "quest", "ss2_up");
			}
		break;
		...
		case "BH_WW1":
			if(CheckAttribute(Pchar, "Bathhouse_pos"))
			{
				...
				{
					case "2":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "ww1_up");
						Pchar.Bathhouse_pos = "3";

						LAi_QuestDelay("BH_officers_WW_up", 0.001);
					break;

					case "3":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "ww1_do");
						Pchar.Bathhouse_pos = "2";
					break;
				}
			}
		...
		case "BH_WW2":
			if(CheckAttribute(Pchar, "Bathhouse_pos"))
			{
				...
				{
					case "2":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "ww2_up");
						Pchar.Bathhouse_pos = "3";
					...
					case "3":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "ww2_do");
						Pchar.Bathhouse_pos = "2";
					break;
				}
			}
		...
		case "BH_WW3":
			if(CheckAttribute(Pchar, "Bathhouse_pos"))
			{
				...
				{
					case "2":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "ww3_up");
						Pchar.Bathhouse_pos = "3";
					...
					case "3":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "ww3_do");
						Pchar.Bathhouse_pos = "2";
					break;
				}
			}
		...
		case "BH_WW4":
			if(CheckAttribute(Pchar, "Bathhouse_pos"))
			{
				...
				{
					case "2":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "ww4_up");
						Pchar.Bathhouse_pos = "3";
					...
					case "3":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "ww4_do");
						Pchar.Bathhouse_pos = "2";
					break;
				}
			}
		...
		case "BH_WW5":
			if(CheckAttribute(Pchar, "Bathhouse_pos"))
			{
				...
				{
					case "2":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "ww5_up");
						Pchar.Bathhouse_pos = "3";
					...
					case "3":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "ww5_do");
						Pchar.Bathhouse_pos = "2";
					break;
				}
			}
		...
		case "BH_officers_WW_up":
			if(GetOfficersIndex(Pchar, 1) != -1)
			{
				iPassenger = GetOfficersIndex(Pchar, 1);
				ChangeCharacterAddressGroup(&Characters[iPassenger], "Singapore_bathhouse", "quest", "ww4_up");
			}

			if(GetOfficersIndex(Pchar, 2) != -1)
			{
				iPassenger = GetOfficersIndex(Pchar, 2);
				ChangeCharacterAddressGroup(&Characters[iPassenger], "Singapore_bathhouse", "quest", "ww3_up");
			}

			if(GetOfficersIndex(Pchar, 3) != -1)
			{
				iPassenger = GetOfficersIndex(Pchar, 3);
				ChangeCharacterAddressGroup(&Characters[iPassenger], "Singapore_bathhouse", "quest", "ww2_up");
			}
		break;
		...
		case "BH_EE1":
			if(CheckAttribute(Pchar, "Bathhouse_pos"))
			{
				...
				{
					case "2":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "ee1_up");
						Pchar.Bathhouse_pos = "3";

						LAi_QuestDelay("BH_officers_EE_up", 0.001);
					break;

					case "3":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "ee1_do");
						Pchar.Bathhouse_pos = "2";
					break;
				}
			}
		...
		case "BH_EE2":
			if(CheckAttribute(Pchar, "Bathhouse_pos"))
			{
				...
				{
					case "2":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "ee2_up");
						Pchar.Bathhouse_pos = "3";
					...
					case "3":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "ee2_do");
						Pchar.Bathhouse_pos = "2";
					break;
				}
			}
		...
		case "BH_EE3":
			if(CheckAttribute(Pchar, "Bathhouse_pos"))
			{
				...
				{
					case "2":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "ee3_up");
						Pchar.Bathhouse_pos = "3";
					...
					case "3":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "ee3_do");
						Pchar.Bathhouse_pos = "2";
					break;
				}
			}
		...
		case "BH_EE4":
			if(CheckAttribute(Pchar, "Bathhouse_pos"))
			{
				...
				{
					case "2":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "ee4_up");
						Pchar.Bathhouse_pos = "3";
					...
					case "3":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "ee4_do");
						Pchar.Bathhouse_pos = "2";
					break;
				}
			}
		...
		case "BH_EE5":
			if(CheckAttribute(Pchar, "Bathhouse_pos"))
			{
				...
				{
					case "2":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "ee5_up");
						Pchar.Bathhouse_pos = "3";
					...
					case "3":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "ee5_do");
						Pchar.Bathhouse_pos = "2";
					break;
				}
			}
		...
		case "BH_officers_EE_up":
			if(GetOfficersIndex(Pchar, 1) != -1)
			{
				iPassenger = GetOfficersIndex(Pchar, 1);
				ChangeCharacterAddressGroup(&Characters[iPassenger], "Singapore_bathhouse", "quest", "ee4_up");
			}

			if(GetOfficersIndex(Pchar, 2) != -1)
			{
				iPassenger = GetOfficersIndex(Pchar, 2);
				ChangeCharacterAddressGroup(&Characters[iPassenger], "Singapore_bathhouse", "quest", "ee3_up");
			}

			if(GetOfficersIndex(Pchar, 3) != -1)
			{
				iPassenger = GetOfficersIndex(Pchar, 3);
				ChangeCharacterAddressGroup(&Characters[iPassenger], "Singapore_bathhouse", "quest", "ee2_up");
			}
		break;
		...
		case "BH_NN1":
			if(CheckAttribute(Pchar, "Bathhouse_pos"))
			{
				...
				{
					case "2":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "nn1_up");
						Pchar.Bathhouse_pos = "3";

						LAi_QuestDelay("BH_officers_NN_up", 0.001);
					break;

					case "3":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "nn1_do");
						Pchar.Bathhouse_pos = "2";
					break;
				}
			}
		...
		case "BH_NN2":
			if(CheckAttribute(Pchar, "Bathhouse_pos"))
			{
				...
				{
					case "2":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "nn2_up");
						Pchar.Bathhouse_pos = "3";
					...
					case "3":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "nn2_do");
						Pchar.Bathhouse_pos = "2";
					break;
				}
			}
		...
		case "BH_NN3":
			if(CheckAttribute(Pchar, "Bathhouse_pos"))
			{
				...
				{
					case "2":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "nn3_up");
						Pchar.Bathhouse_pos = "3";
					...
					case "3":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "nn3_do");
						Pchar.Bathhouse_pos = "2";
					break;
				}
			}
		...
		case "BH_NN4":
			if(CheckAttribute(Pchar, "Bathhouse_pos"))
			{
				...
				{
					case "2":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "nn4_up");
						Pchar.Bathhouse_pos = "3";
					...
					case "3":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "nn4_do");
						Pchar.Bathhouse_pos = "2";
					break;
				}
			}
		...
		case "BH_NN5":
			if(CheckAttribute(Pchar, "Bathhouse_pos"))
			{
				...
				{
					case "2":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "nn5_up");
						Pchar.Bathhouse_pos = "3";
					...
					case "3":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "nn5_do");
						Pchar.Bathhouse_pos = "2";
					break;
				}
			}
		...
		case "BH_officers_NN_up":
			if(GetOfficersIndex(Pchar, 1) != -1)
			{
				iPassenger = GetOfficersIndex(Pchar, 1);
				ChangeCharacterAddressGroup(&Characters[iPassenger], "Singapore_bathhouse", "quest", "nn4_up");
			}

			if(GetOfficersIndex(Pchar, 2) != -1)
			{
				iPassenger = GetOfficersIndex(Pchar, 2);
				ChangeCharacterAddressGroup(&Characters[iPassenger], "Singapore_bathhouse", "quest", "nn3_up");
			}

			if(GetOfficersIndex(Pchar, 3) != -1)
			{
				iPassenger = GetOfficersIndex(Pchar, 3);
				ChangeCharacterAddressGroup(&Characters[iPassenger], "Singapore_bathhouse", "quest", "nn2_up");
			}
		break;
		...
		case "BH_SC1":
			if(CheckAttribute(Pchar, "Bathhouse_pos"))
			{
				...
				{
					case "1":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "sc1_up");
						Pchar.Bathhouse_pos = "2";
					break;

					case "2":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "sc1_do");
						Pchar.Bathhouse_pos = "1";

						LAi_QuestDelay("BH_officers_SC_down", 0.001);
					break;
				}
			}
		...
		case "BH_SC2":
			if(CheckAttribute(Pchar, "Bathhouse_pos"))
			{
				...
				{
					case "1":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "sc2_up");
						Pchar.Bathhouse_pos = "2";
					break;

					case "2":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "sc2_do");
						Pchar.Bathhouse_pos = "1";
		...
		case "BH_SC3":
			if(CheckAttribute(Pchar, "Bathhouse_pos"))
			{
				...
				{
					case "1":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "sc3_up");
						Pchar.Bathhouse_pos = "2";
					break;

					case "2":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "sc3_do");
						Pchar.Bathhouse_pos = "1";
		...
		case "BH_SC4":
			if(CheckAttribute(Pchar, "Bathhouse_pos"))
			{
				...
				{
					case "1":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "sc4_up");
						Pchar.Bathhouse_pos = "2";
					break;

					case "2":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "sc4_do");
						Pchar.Bathhouse_pos = "1";
		...
		case "BH_SC5":
			if(CheckAttribute(Pchar, "Bathhouse_pos"))
			{
				...
				{
					case "1":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "sc5_up");
						Pchar.Bathhouse_pos = "2";
					break;

					case "2":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "sc5_do");
						Pchar.Bathhouse_pos = "1";
		...
		case "BH_officers_SC_down":
			if(GetOfficersIndex(Pchar, 1) != -1)
			{
				iPassenger = GetOfficersIndex(Pchar, 1);
				ChangeCharacterAddressGroup(&Characters[iPassenger], "Singapore_bathhouse", "quest", "sc4_do");
			}

			if(GetOfficersIndex(Pchar, 2) != -1)
			{
				iPassenger = GetOfficersIndex(Pchar, 2);
				ChangeCharacterAddressGroup(&Characters[iPassenger], "Singapore_bathhouse", "quest", "sc3_do");
			}

			if(GetOfficersIndex(Pchar, 3) != -1)
			{
				iPassenger = GetOfficersIndex(Pchar, 3);
				ChangeCharacterAddressGroup(&Characters[iPassenger], "Singapore_bathhouse", "quest", "sc2_do");
			}
		break;
		...
		case "BH_WC1":
			if(CheckAttribute(Pchar, "Bathhouse_pos"))
			{
				...
				{
					case "1":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "wc1_up");
						Pchar.Bathhouse_pos = "2";
					break;

					case "2":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "wc1_do");
						Pchar.Bathhouse_pos = "1";

						LAi_QuestDelay("BH_officers_WC_down", 0.001);;
					break;
				}
			}
		...
		case "BH_WC2":
			if(CheckAttribute(Pchar, "Bathhouse_pos"))
			{
				...
				{
					case "1":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "wc2_up");
						Pchar.Bathhouse_pos = "2";
					break;

					case "2":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "wc2_do");
						Pchar.Bathhouse_pos = "1";
		...
		case "BH_WC3":
			if(CheckAttribute(Pchar, "Bathhouse_pos"))
			{
				...
				{
					case "1":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "wc3_up");
						Pchar.Bathhouse_pos = "2";
					break;

					case "2":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "wc3_do");
						Pchar.Bathhouse_pos = "1";
		...
		case "BH_WC4":
			if(CheckAttribute(Pchar, "Bathhouse_pos"))
			{
				...
				{
					case "1":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "wc4_up");
						Pchar.Bathhouse_pos = "2";
					break;

					case "2":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "wc4_do");
						Pchar.Bathhouse_pos = "1";
		...
		case "BH_WC5":
			if(CheckAttribute(Pchar, "Bathhouse_pos"))
			{
				...
				{
					case "1":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "wc5_up");
						Pchar.Bathhouse_pos = "2";
					break;

					case "2":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "wc5_do");
						Pchar.Bathhouse_pos = "1";
		...
		case "BH_officers_WC_down":
			if(GetOfficersIndex(Pchar, 1) != -1)
			{
				iPassenger = GetOfficersIndex(Pchar, 1);
				ChangeCharacterAddressGroup(&Characters[iPassenger], "Singapore_bathhouse", "quest", "wc4_do");
			}

			if(GetOfficersIndex(Pchar, 2) != -1)
			{
				iPassenger = GetOfficersIndex(Pchar, 2);
				ChangeCharacterAddressGroup(&Characters[iPassenger], "Singapore_bathhouse", "quest", "wc3_do");
			}

			if(GetOfficersIndex(Pchar, 3) != -1)
			{
				iPassenger = GetOfficersIndex(Pchar, 3);
				ChangeCharacterAddressGroup(&Characters[iPassenger], "Singapore_bathhouse", "quest", "wc2_do");
			}
		break;
		...
		case "BH_EC1":
			if(CheckAttribute(Pchar, "Bathhouse_pos"))
			{
				...
				{
					case "1":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "ec1_up");
						Pchar.Bathhouse_pos = "2";
					break;

					case "2":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "ec1_do");
						Pchar.Bathhouse_pos = "1";

						LAi_QuestDelay("BH_officers_EC_down", 0.001);
					break;
				}
			}
		...
		case "BH_EC2":
			if(CheckAttribute(Pchar, "Bathhouse_pos"))
			{
				...
				{
					case "1":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "ec2_up");
						Pchar.Bathhouse_pos = "2";
					break;

					case "2":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "ec2_do");
						Pchar.Bathhouse_pos = "1";
		...
		case "BH_EC3":
			if(CheckAttribute(Pchar, "Bathhouse_pos"))
			{
				...
				{
					case "1":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "ec3_up");
						Pchar.Bathhouse_pos = "2";
					break;

					case "2":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "ec3_do");
						Pchar.Bathhouse_pos = "1";
		...
		case "BH_EC4":
			if(CheckAttribute(Pchar, "Bathhouse_pos"))
			{
				...
				{
					case "1":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "ec4_up");
						Pchar.Bathhouse_pos = "2";
					break;

					case "2":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "ec4_do");
						Pchar.Bathhouse_pos = "1";
		...
		case "BH_EC5":
			if(CheckAttribute(Pchar, "Bathhouse_pos"))
			{
				...
				{
					case "1":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "ec5_up");
						Pchar.Bathhouse_pos = "2";
					break;

					case "2":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "ec5_do");
						Pchar.Bathhouse_pos = "1";
		...
		case "BH_officers_EC_down":
			if(GetOfficersIndex(Pchar, 1) != -1)
			{
				iPassenger = GetOfficersIndex(Pchar, 1);
				ChangeCharacterAddressGroup(&Characters[iPassenger], "Singapore_bathhouse", "quest", "ec4_do");
			}

			if(GetOfficersIndex(Pchar, 2) != -1)
			{
				iPassenger = GetOfficersIndex(Pchar, 2);
				ChangeCharacterAddressGroup(&Characters[iPassenger], "Singapore_bathhouse", "quest", "ec3_do");
			}

			if(GetOfficersIndex(Pchar, 3) != -1)
			{
				iPassenger = GetOfficersIndex(Pchar, 3);
				ChangeCharacterAddressGroup(&Characters[iPassenger], "Singapore_bathhouse", "quest", "ec2_do");
			}
		break;
		...
		case "BH_NC1":
			if(CheckAttribute(Pchar, "Bathhouse_pos"))
			{
				...
				{
					case "1":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "nc1_up");
						Pchar.Bathhouse_pos = "2";
					break;

					case "2":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "nc1_do");
						Pchar.Bathhouse_pos = "1";

						LAi_QuestDelay("BH_officers_NC_down", 0.001);
					break;
				}
			}
		...
		case "BH_NC2":
			if(CheckAttribute(Pchar, "Bathhouse_pos"))
			{
				...
				{
					case "1":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "nc2_up");
						Pchar.Bathhouse_pos = "2";
					break;

					case "2":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "nc2_do");
						Pchar.Bathhouse_pos = "1";
		...
		case "BH_NC3":
			if(CheckAttribute(Pchar, "Bathhouse_pos"))
			{
				...
				{
					case "1":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "nc3_up");
						Pchar.Bathhouse_pos = "2";
					break;

					case "2":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "nc3_do");
						Pchar.Bathhouse_pos = "1";
		...
		case "BH_NC4":
			if(CheckAttribute(Pchar, "Bathhouse_pos"))
			{
				...
				{
					case "1":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "nc4_up");
						Pchar.Bathhouse_pos = "2";
					break;

					case "2":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "nc4_do");
						Pchar.Bathhouse_pos = "1";
		...
		case "BH_NC5":
			if(CheckAttribute(Pchar, "Bathhouse_pos"))
			{
				...
				{
					case "1":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "nc5_up");
						Pchar.Bathhouse_pos = "2";
					break;

					case "2":
						ChangeCharacterAddressGroup(Pchar, "Singapore_bathhouse", "quest", "nc5_do");
						Pchar.Bathhouse_pos = "1";
		...
		case "BH_officers_NC_down":
			if(GetOfficersIndex(Pchar, 1) != -1)
			{
				iPassenger = GetOfficersIndex(Pchar, 1);
				ChangeCharacterAddressGroup(&Characters[iPassenger], "Singapore_bathhouse", "quest", "nc4_do");
			}

			if(GetOfficersIndex(Pchar, 2) != -1)
			{
				iPassenger = GetOfficersIndex(Pchar, 2);
				ChangeCharacterAddressGroup(&Characters[iPassenger], "Singapore_bathhouse", "quest", "nc3_do");
			}

			if(GetOfficersIndex(Pchar, 3) != -1)
			{
				iPassenger = GetOfficersIndex(Pchar, 3);
				ChangeCharacterAddressGroup(&Characters[iPassenger], "Singapore_bathhouse", "quest", "nc2_do");
			}
		break;
		...
		case "BH_steam":
			if(GetAttribute(Pchar, "BH_steam") == "off") return;
			...
			switch(steam)
			{
				...
				case 1:
					//ri15
					PlaySound("INTERFACE\fire_on.wav");
					CreateParticleSystem("smoke" , 4.9, 0.1, 3.9, -1.57, 0.0, 0.0, 2);
					CreateParticleSystem("waterfog" , 4.9, 0.1, 3.9, -1.57, 0.0, 0.0, 2);
				break;

				case 2:
					//ri2 etc
					PlaySound("INTERFACE\fire_on.wav");
					CreateParticleSystem("smoke" , 14.9, 0.1, -8.2, -1.57, 0.0, 0.0, 2);
					CreateParticleSystem("waterfog" , 14.9, 0.1, -8.2, -1.57, 0.0, 0.0, 2);
				break;

				case 3:
					PlaySound("INTERFACE\oxygen.wav");
					CreateParticleSystem("smoke" , 24.9, 2.1, 6.9, -1.57, 0.0, 0.0, 2);
					CreateParticleSystem("waterfog" , 24.9, 2.1, 6.9, -1.57, 0.0, 0.0, 2);
				break;
				...
				case 5:
					PlaySound("INTERFACE\oxygen.wav");
					CreateParticleSystem("smoke" , 29.1, 2.1, -7.2, -1.57, 0.0, 0.0, 2);
					CreateParticleSystem("waterfog" , 29.1, 2.1, -7.2, -1.57, 0.0, 0.0, 2);
				break;

				case 6:
					PlaySound("INTERFACE\oxygen.wav");
					CreateParticleSystem("smoke" , -14.2, 2.1, 6.9, -1.57, 0.0, 0.0, 2);
					CreateParticleSystem("waterfog" , -14.2, 2.1, 6.9, -1.57, 0.0, 0.0, 2);
				break;

				case 7:
					PlaySound("INTERFACE\gas_off2.wav");
					CreateParticleSystem("smoke" , -14.1, 2.1, -22.3, -1.57, 0.0, 0.0, 2);
					CreateParticleSystem("waterfog" , -14.1, 2.1, -22.3, -1.57, 0.0, 0.0, 2);
				break;

				case 8:
					PlaySound("INTERFACE\oxygen.wav");
					CreateParticleSystem("smoke" , -18.2, 2.1, -7.2, -1.57, 0.0, 0.0, 2);
					CreateParticleSystem("waterfog" , -18.3, 2.1, -7.2, -1.57, 0.0, 0.0, 2);
				break;

				case 9:
					PlaySound("INTERFACE\gas_off2.wav");
					CreateParticleSystem("smoke" , 22.9, 2.1, -38.3, -1.57, 0.0, 0.0, 2);
					CreateParticleSystem("waterfog" , 22.9, 2.1, -38.3, -1.57, 0.0, 0.0, 2);
				break;
				...
				case 11:
					...
					CreateParticleSystem("waterfog" , 8.9, 2.1, -40.3, -1.57, 0.0, 0.0, 2);

					CreateParticleSystem("smoke" , 1.9, 2.1, -40.3, -1.57, 0.0, 0.0, 2);
					CreateParticleSystem("waterfog" , 1.9, 2.1, -40.3, -1.57, 0.0, 0.0, 2);
				break;
				...
				case 13:
					PlaySound("INTERFACE\fire_on.wav");
					CreateParticleSystem("smoke" , -4.2, 0.1, -7.2, -1.57, 0.0, 0.0, 2);
					CreateParticleSystem("waterfog" , -4.2, 0.1, -7.2, -1.57, 0.0, 0.0, 2);
				break;
			}

			LAi_QuestDelay("BH_steam_delay", 4.0);
		break;

		case "BH_steam_delay":
			int steam_delay = rand(4);
			switch(steam_delay)
			{
				case 0: LAi_QuestDelay("BH_steam", 0.1); break;
				case 1: LAi_QuestDelay("BH_steam", 1.0); break;
				case 2: LAi_QuestDelay("BH_steam", 2.0); break;
				case 3: LAi_QuestDelay("BH_steam", 3.0); break;
				case 4: LAi_QuestDelay("BH_steam", 4.0); break;
				case 5: LAi_QuestDelay("BH_steam", 5.0); break;
			}
		break;
		...
		case "BH_steam_off":
			...
			pchar.quest.BH_steam_on.win_condition.l1 = "location";
		...
		case "BH_steam_on":
			...
			LAi_QuestDelay("BH_steam", 4.0);

			Pchar.quest.BH_steam_off.win_condition.l1 = "ExitFromLocation";
			Pchar.quest.BH_steam_off.win_condition.l1.location = "Singapore_bathhouse";
			Pchar.quest.BH_steam_off.win_condition = "BH_steam_off";
		break;
		...
		case "BH_fog_off":
			...
			pchar.quest.BH_fog_on.win_condition.l1 = "locator";
			pchar.quest.BH_fog_on.win_condition.l1.location = "Bathhouse_stairs";
			pchar.quest.BH_fog_on.win_condition.l1.locator_group = "reload";
		...
		case "BH_fog_on":
			...
			pchar.quest.BH_fog_off.win_condition.l1 = "locator";
			pchar.quest.BH_fog_off.win_condition.l1.location = "Bathhouse_stairs";
			pchar.quest.BH_fog_off.win_condition.l1.locator_group = "reload";
			pchar.quest.BH_fog_off.win_condition.l1.locator = "reload1";
			pchar.quest.BH_fog_off.win_condition = "BH_fog_off";
		break;
