...
int TimeScaleCounter = 0; // Boyer 14.08.2021.
int ngMusicID = 0;
string sgMusicName = "?";
...
#define	MAX_ISLANDS			25 // ditto, and now use ISLANDS_QUANTITY. 8
...
#define BUILDVERSION			"14 (August 2025)"	// this is not used in reinit.c anymore, so we can use a string now
