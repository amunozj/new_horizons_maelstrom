...
// Night4
	...
	Weathers[n].Sea2.MoveSpeed1 = "3.0, 0.0, 0.0"; //�������� ��������
	...
	Weathers[n].Sea2.FoamK = 0;//������� ���� �� ������ 0.1 - ���� ����� � 10 ������ 1.0 ����� ���� ����� ������
	Weathers[n].Sea2.FoamV = 0;//������ � ������� ���������� ����
	Weathers[n].Sea2.FoamUV = 0; //������� ����
	Weathers[n].Sea2.FoamTexDisturb = 0;//����� �� �������. �.�. ��� ��� ���� �������. �������� �� 0.0 �� 1.0
