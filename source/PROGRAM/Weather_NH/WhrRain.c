...
void FillRainData()
{
	...
	aref aRain1; makearef(aRain1, currentWeather.Rain);
	aref aRainbow1; makearef(aRainbow1, currentWeather.Rainbow);

	Rain.Clear = "";
	DeleteAttribute(&Rain,"");

	aref aRain2; makearef(aRain2, nextWeather.Rain);
	aref aRainbow2; makearef(aRainbow2, nextWeather.Rainbow);
