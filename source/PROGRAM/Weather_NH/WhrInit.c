#include "Weather_NH\Init\Common.c"
#include "Weather_NH\Init\Day.c"
#include "Weather_NH\Init\Evening.c"
#include "Weather_NH\Init\Morning.c"
...
int InitWeather()
{
	...
	for (int i=0; i<n; i++)
	{
		...
		if (!CheckAttribute(&Weathers[i], "Rain.DropsTexture")) { Weathers[i].Rain.DropsTexture = "Weather_NH\rain_drops.tga.tx"; }
