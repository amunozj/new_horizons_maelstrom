#include "weather\WhrUtils_NH.c"
#include "weather\WhrLightning_NH.c"
#include "weather\WhrRain_NH.c"
#include "weather\WhrSea_NH.c"
#include "weather\WhrSky_NH.c"
#include "weather\WhrSun_NH.c"
#include "weather\WhrTornado_NH.c"
...
void WeatherInit()
{
	...
	if (LoadSegment("weather\WhrInit_NH.c"))
	{
		iTotalNumWeathers = InitWeather();
		UnloadSegment("weather\WhrInit_NH.c");
	}
}
