...
// Morning2
	...
	Weathers[n].Sea2.BumpScale = 0.05; //ÌÅËÊÈÅ ÂÎËÍÛ
	Weathers[n].Sea2.PosShift = 2.0; //îñòðîêîíå÷íîñòü âîëí
	...
	Weathers[n].Sea2.Amp1 = 2.5; //àìïëèòóäà 1 âîëíû
	Weathers[n].Sea2.AnimSpeed1 = 2.0; //ñêîðîñòü àíèìàöèè
	Weathers[n].Sea2.Scale1 = 0.25; //ðàçìåðû âîëíû
	Weathers[n].Sea2.MoveSpeed1 = "1.0, 0.0, 7.5"; //ñêîðîñòü äâèæåíèÿ
	...
	Weathers[n].Sea2.FoamK = 0.1;//ÿðêîñòü ïåíû ïî âûñîòå 0.1 - ïåíà ÿðêàÿ ñ 10 ìåòðîâ 1.0 ÷åðåç ìåòð ïîñëå íà÷àëà
	Weathers[n].Sea2.FoamV = 2.0;//âûñîòà ñ êîòîðîé íà÷èíàåòñÿ ïåíà
	Weathers[n].Sea2.FoamUV = 1.0; //òàéëèíã ïåíû
	Weathers[n].Sea2.FoamTexDisturb = 0.7;//ñäâèã ïî íîðìàëè. õ.ç. ÷òî ýòî íàäî ïîþçàòü. çíà÷åíèå îò 0.0 äî 1.0
...
// Morning3 7 ÷àñîâ
	...
	Weathers[n].Sea2.FoamK = 0.06;//ÿðêîñòü ïåíû ïî âûñîòå 0.1 - ïåíà ÿðêàÿ ñ 10 ìåòðîâ 1.0 ÷åðåç ìåòð ïîñëå íà÷àëà
	Weathers[n].Sea2.FoamV = 2.0;//âûñîòà ñ êîòîðîé íà÷èíàåòñÿ ïåíà
	Weathers[n].Sea2.FoamUV = 1.0; //òàéëèíã ïåíû
	Weathers[n].Sea2.FoamTexDisturb = 0.3;//ñäâèã ïî íîðìàëè. õ.ç. ÷òî ýòî íàäî ïîþçàòü. çíà÷åíèå îò 0.0 äî 1.0
...
// Morning4 8 ÷àñîâ
	...
	Weathers[n].Sea2.FoamK = 0.05;//ÿðêîñòü ïåíû ïî âûñîòå 0.1 - ïåíà ÿðêàÿ ñ 10 ìåòðîâ 1.0 ÷åðåç ìåòð ïîñëå íà÷àëà
	Weathers[n].Sea2.FoamV = 6.0;//âûñîòà ñ êîòîðîé íà÷èíàåòñÿ ïåíà
	Weathers[n].Sea2.FoamUV = 0.3; //òàéëèíã ïåíû
	Weathers[n].Sea2.FoamTexDisturb = 0.3;//ñäâèã ïî íîðìàëè. õ.ç. ÷òî ýòî íàäî ïîþçàòü. çíà÷åíèå îò 0.0 äî 1.0
...
// Morning1 9 ÷àñîâ
	...
	Weathers[n].Sea2.FoamK = 0.03;//ÿðêîñòü ïåíû ïî âûñîòå 0.1 - ïåíà ÿðêàÿ ñ 10 ìåòðîâ 1.0 ÷åðåç ìåòð ïîñëå íà÷àëà
	Weathers[n].Sea2.FoamV = 5.0;//âûñîòà ñ êîòîðîé íà÷èíàåòñÿ ïåíà
	Weathers[n].Sea2.FoamUV = 0.1; //òàéëèíã ïåíû
	Weathers[n].Sea2.FoamTexDisturb = 0.7;//ñäâèã ïî íîðìàëè. õ.ç. ÷òî ýòî íàäî ïîþçàòü. çíà÷åíèå îò 0.0 äî 1.0
...
// Morning1 10 ÷àñîâ
	...
	Weathers[n].Sea2.FoamK = 0.05;//ÿðêîñòü ïåíû ïî âûñîòå 0.1 - ïåíà ÿðêàÿ ñ 10 ìåòðîâ 1.0 ÷åðåç ìåòð ïîñëå íà÷àëà
	Weathers[n].Sea2.FoamV = 9.0;//âûñîòà ñ êîòîðîé íà÷èíàåòñÿ ïåíà
	Weathers[n].Sea2.FoamUV = 0.3; //òàéëèíã ïåíû
	Weathers[n].Sea2.FoamTexDisturb = 0.7;//ñäâèã ïî íîðìàëè. õ.ç. ÷òî ýòî íàäî ïîþçàòü. çíà÷åíèå îò 0.0 äî 1.0
