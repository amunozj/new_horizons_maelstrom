...
// Evening1 19 ÷àñîâ
	...
	Weathers[n].Sea2.PosShift = 0.0; //îñòðîêîíå÷íîñòü âîëí
	...
	Weathers[n].Sea2.Amp1 = 7.0; //àìïëèòóäà 1 âîëíû
	Weathers[n].Sea2.AnimSpeed1 = 2.0; //ñêîðîñòü àíèìàöèè
	Weathers[n].Sea2.Scale1 = 0.30; //ðàçìåðû âîëíû
	Weathers[n].Sea2.MoveSpeed1 = "2.0, 0.0, 0.0"; //ñêîðîñòü äâèæåíèÿ
...
// Eveninng4
	...
	Weathers[n].Sea2.BumpScale = 0.05; //ÌÅËÊÈÅ ÂÎËÍÛ
	Weathers[n].Sea2.PosShift = 1.0; //îñòðîêîíå÷íîñòü âîëí
	...
	Weathers[n].Sea2.Amp1 = 10.0; //àìïëèòóäà 1 âîëíû
	Weathers[n].Sea2.AnimSpeed1 = 0.5; //ñêîðîñòü àíèìàöèè
	Weathers[n].Sea2.Scale1 = 0.3; //ðàçìåðû âîëíû
	Weathers[n].Sea2.MoveSpeed1 = "5.0, 0.0, 0.0"; //ñêîðîñòü äâèæåíèÿ
	...
	Weathers[n].Sea2.FoamK = 0.2;//ÿðêîñòü ïåíû ïî âûñîòå 0.1 - ïåíà ÿðêàÿ ñ 10 ìåòðîâ 1.0 ÷åðåç ìåòð ïîñëå íà÷àëà
	Weathers[n].Sea2.FoamV = 6.5;//âûñîòà ñ êîòîðîé íà÷èíàåòñÿ ïåíà
	Weathers[n].Sea2.FoamUV = 0.2; //òàéëèíã ïåíû
	Weathers[n].Sea2.FoamTexDisturb = 0.2;//ñäâèã ïî íîðìàëè. õ.ç. ÷òî ýòî íàäî ïîþçàòü. çíà÷åíèå îò 0.0 äî 1.0
