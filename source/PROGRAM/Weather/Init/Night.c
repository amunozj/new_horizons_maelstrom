...
// Night1
	...
	Weathers[n].Sea2.FoamK = 0.2;//¤ркость пены по высоте 0.1 - пена ¤рка¤ с 10 метров 1.0 через метр после начала
	Weathers[n].Sea2.FoamV = 6.5;//высота с которой начинаетс¤ пена
...
// Night4
	...
	Weathers[n].Sea2.FoamK = 0;//яркость пены по высоте 0.1 - пена яркая с 10 метров 1.0 через метр после начала
	Weathers[n].Sea2.FoamV = 0;//высота с которой начинается пена
	Weathers[n].Sea2.FoamUV = 0; //тайлинг пены
	Weathers[n].Sea2.FoamTexDisturb = 0;//сдвиг по нормали. х.з. что это надо поюзать. значение от 0.0 до 1.0
