...
// Levis: Casino people
	...
	ch.name    = ""
	ch.lastname    = ""
	ch.id        = "Casino Roulette";
	ch.model    = "9R_Purs";
	ch.sex = "man";
	ch.sound_type = "male_citizen";
	ch.location    = "Cartagena Casino";
	ch.location.group = "characters";
	ch.location.locator = "roulette";
	ch.Dialog.Filename = "Cartagena citizen_dialog.c";
 	ch.greeting = "Gr_isla muelle citizen";
	ch.nation = SPAIN;
	ch.rank    = 1;
...
// Levis: Character which will be used later
	ch.old.name = "Chima";
	ch.old.lastname = "";
	ch.name    = TranslateString("", "Chima");
	ch.lastname    = "";
	ch.id        = "Chima";
	ch.model    = "medicine_woman";
	ch.sex = "woman";
	ch.sound_type = "female_citizen";
	ch.location    = "House Grandma";
	ch.location.group = "goto";
	ch.location.locator = "goto1";
	ch.Dialog.Filename = "Chima_dialog.c";
	ch.greeting = "";
	ch.nation = SPAIN;
	ch.rank    = 20;
	ch.reputation = "None";
	...
	ch.old.name = "Alejandro";
	ch.old.lastname = "de Mendoza";
	ch.name    = TranslateString("", "Alejandro");
	ch.lastname    = TranslateString("", "de Mendoza");
	ch.id        = "Alejandro de Mendoza";
	ch.model    = "offic_per";
	ch.sex = "man";
	ch.sound_type = "male_citizen";
	ch.location    = "Cartagena Mansion Town";
	ch.location.group = "sit";
	ch.location.locator = "sit1";
...
// Officer of Casa de Contratación
	...
	LAi_SetHuberType(ch);
	LAi_group_MoveCharacter(ch, "SPAIN_CITIZENS");
	ch.greeting = "Gr_CdC_Officer";
	AddGameCharacter(n, ch);

// New Cloister
	ch.old.name = "Librarian";
	ch.old.lastname = "";
	ch.name = TranslateString("", "Librarian");
	ch.lastname = "";
	ch.id		= "NC_monkL";
	ch.model	= "Animists3_empty";
	ch.sex = "man";
	GiveItem2Character(ch, "zombie_touch");
	ch.equip.blade = "zombie_touch";
	ch.location	= "new_cloister_library";
	ch.location.group = "goto";
	ch.location.locator = "monster1";
	ch.Dialog.Filename = "New cloister monk_dialog.c";
	ch.nation = SPAIN;
	ch.rank 	= 1;
	ch.reputation = "None";
	ch.experience = "1000";
	...
	ch.location	= "new_cloister_garden";
	ch.location.group = "goto";
	ch.location.locator = "goto3";
	ch.Dialog.Filename = "New cloister monk_dialog.c";
	ch.nation = SPAIN;
	...
	GiveItem2Character(ch, "bladeX4");
	ch.equip.blade = "bladeX4";
	ch.location	= "new_cloister_graveyard";
	ch.location.group = "goto";
	ch.location.locator = "gr1";
	ch.Dialog.Filename = "New cloister monk_dialog.c";
	ch.nation = SPAIN;
	ch.rank 	= 1;
	ch.reputation = "None";
	...
	GiveItem2Character(ch, "bladeX4");
	ch.equip.blade = "bladeX4";
	ch.location	= "new_cloister_inside";
	ch.location.group = "sit";
	ch.location.locator = "sit1";
	ch.Dialog.Filename = "New cloister monk_dialog.c";
	ch.nation = SPAIN;
	...
	GiveItem2Character(ch, "bladeX4");
	ch.equip.blade = "bladeX4";
	ch.location	= "new_cloister_chapel";
	ch.location.group = "goto";
	ch.location.locator = "goto12";
	ch.Dialog.Filename = "New cloister monk_dialog.c";
	ch.nation = SPAIN;
